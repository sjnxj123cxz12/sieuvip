...
"LabelIncrement.SicboDPQ": [ function(t, e) {
"use strict";
cc._RF.push(e, "2db3chcn49Jo7Hmqj8za7Qd", "LabelIncrement.SicboDPQ");
(function() {
cc.LabelIncrementSicboDPQ = cc.Class({
...
if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) c = Reflect.decorate(t, e, o, i); else for (var a = t.length - 1; a >= 0; a--) (n = t[a]) && (c = (s < 3 ? n(c) : s > 3 ? n(e, o, c) : n(e, o)) || c);
...
var e = t.Result, o = t.ChipsData.split(","), i = parseInt(o[0]), n = parseInt(o[1]), s = parseInt(o[2]);
return i == n && i == s ? this.sfNodeDice[2] : e < 11 ? this.sfNodeDice[0] : this.sfNodeDice[1];
};
e.prototype.getSprRankID = function(t) {
return this.listSprRank[t];
};
var o;
s([ r(cc.SpriteFrame) ], e.prototype, "avatarDefault", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "listAvatar", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "listSprRank", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfChips", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfDicesV2", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfNans", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfNodeDice", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfBacks", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfDots", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfGateBet", void 0);
return o = s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
var c = t("../../network/SicboDPQ.NetWorkClient"), a = t("../../SicboDPQ.Common"), r = t("../../SicboDPQ.Controller"), l = t("./SicboDPQ.ChatListView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.chatListView = null;
...
var o;
e.instance = null;
s([ h(l.default) ], e.prototype, "chatListView", void 0);
s([ h(cc.EditBox) ], e.prototype, "edBoxChat", void 0);
s([ h(cc.Button) ], e.prototype, "btnSendChat", void 0);
s([ h(cc.Node) ], e.prototype, "nodeDismiss", void 0);
s([ h(cc.Node) ], e.prototype, "nodeEmotion", void 0);
s([ h(cc.Node) ], e.prototype, "nodeNormalChat", void 0);
return o = s([ u ], e);
}(cc.Component);
o.default = d;
cc._RF.pop();
...
var c = t("../../SicboDPQ.Assets"), a = t("../../SicboDPQ.InfoView"), r = cc._decorator, l = r.ccclass, p = r.property, u = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
e.children[2].getComponent(cc.Sprite).spriteFrame = c.default.instance.getSprRankID(parseInt(t[5]) - 1);
e.children[3].getComponent(cc.Label).string = t[1];
e.active = !0;
e.parent = this.content;
this.srcContent.scrollToBottom();
};
s([ p(cc.Node) ], e.prototype, "content", void 0);
s([ p(cc.Node) ], e.prototype, "template", void 0);
s([ p(cc.ScrollView) ], e.prototype, "srcContent", void 0);
return s([ l ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
var c = t("./SicboDPQ.Assets"), a = t("./SicboDPQ.ChipPool"), r = t("./SicboDPQ.Controller"), l = t("./SicboDPQ.InputView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.spriteChip = null;
...
this.chipIndex = t;
this.spriteChip.spriteFrame = c.default.instance.getChip(t);
};
...
var n = this.position.lerp(t, 1), s = this.node.parent.convertToWorldSpaceAR(this.node.position), c = (this.node.convertToNodeSpaceAR(s), 
e % 2 == 0 ? n.x - n.x / 2 : -(n.x - n.x / 2)), a = e % 2 == 0 ? n.y - n.y / 2 : -(n.y - n.y / 2), r = (cc.bezierTo(o, [ cc.v2(this.node.position.x, this.node.position.y / 2), cc.v2(c, a), t ]), 
...
i.easing(cc.easeQuadraticActionInOut());
var n = this.position.lerp(t, 1), s = this.node.parent.convertToWorldSpaceAR(this.node.position), c = (this.node.convertToNodeSpaceAR(s), 
e % 2 == 0 ? n.x - n.x / 2 : -(n.x - n.x / 2)), a = e % 2 == 0 ? n.y - n.y / 2 : -(n.y - n.y / 2), r = (cc.bezierTo(o, [ cc.v2(this.node.position.x, this.node.position.y), cc.v2(c, a), t ]), 
...
var o;
s([ h(cc.Sprite) ], e.prototype, "spriteChip", void 0);
return o = s([ u ], e);
}(cc.Component);
o.default = d;
cc._RF.pop();
...
var o;
s([ r(cc.Prefab) ], e.prototype, "chip", void 0);
return o = s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
var e = (t = t.split("T"))[0], o = t[1].split(":"), i = o[0], n = o[1], s = parseInt(i, 10), c = s >= 12 ? "PM" : "AM";
return "" + e + (s = s % 12 || 12) + ":" + n + " " + c;
};
t.formatDateTime4 = function(t) {
var e = (t = t.split("T"))[0], o = t[1].split(":"), i = o[0], n = o[1], s = o[2];
return e + " (" + i + ":" + n + ":" + Math.round(s) + ")";
};
t.formatDateTime3 = function(t) {
var e = (t = t.split("T"))[1].split(":"), o = e[0], i = e[1], n = parseInt(o, 10), s = n >= 12 ? "PM" : "AM";
return (n = n % 12 || 12) + ":" + i + " " + s;
};
...
i.onload = function() {
if (200 === this.status) {
for (var t = this.response, i = new Uint8Array(t), n = "", s = 0; s < i.byteLength; s++) n += String.fromCharCode(i[s]);
var c = "data:image/png;base64," + window.btoa(n);
e(c);
...
var c = t("../../framework/common/ConfirmDialog"), a = t("../../framework/common/Dialog"), r = t("./network/SicboDPQ.NetWorkClient"), l = t("./popup/chat/SicboDPQ.ChatController"), p = t("./popup/SicboDPQ.GraphView"), u = t("./popup/SicboDPQ.History"), h = t("./popup/SicboDPQ.MaxBet"), d = t("./popup/SicboDPQ.PlayersNotInGame"), f = t("./popup/SicboDPQ.TopRank"), S = t("./SicboDPQ.Common"), y = t("./SicboDPQ.Config"), b = t("./SicboDPQ.InfoView"), g = t("./SicboDPQ.InputView"), m = t("./SicboDPQ.ResultView"), v = cc._decorator, P = v.ccclass, D = v.property, C = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.spriteSound = null;
...
switch (e) {
case "sessionInfo":
b.default.instance.updateInfo(o[0], o[0].Phrase, null);
g.default.instance.updateInput(o[0].Phrase);
break;

case "gameHistory":
b.default.instance.setListSoiCau(o[0]);
break;

case "startActionTimer":
b.default.instance.updateInfo(o[0], o[2], o[1]);
m.default.instance.updateResult(null, o[0].Result, o[0].ChipsData, o[2], null, null === (i = o[0]) || void 0 === i ? void 0 : i.BigWinString);
g.default.instance.updateInput(o[2]);
break;

case "playerLeave":
if (o && o.length > 0) {
b.default.instance.playerLeave(o);
t.playerLeave(o);
}
break;

case "joinGame":
b.default.instance.updateInfoCurrPlayer(o[0].Account);
break;

case "betSession":
g.default.instance.showLastInput(o[0]);
break;

case "playerBet":
g.default.instance.playerBet(o);
break;

case "betSuccess":
g.default.instance.ShowMyBets(o);
break;

case "winResultVip":
try {
setTimeout(function() {
t.node && b.default.instance.winResultVip(o[0]);
}, 2500);
} catch (t) {
console.error(t);
}
...
try {
setTimeout(function() {
t.node && b.default.instance.winResult(o[0]);
}, 2500);
} catch (t) {
console.error(t);
}
...
t.node && b.default.instance.totalUserWin(o[0]);
}, 2500);
break;
...
g.default.instance.updateInput(S.default.GAMESTATE.OPEN_PLATE);
break;

case "receiveMessage":
l.default.instance.addChatContent(o);
b.default.instance.playerShowBubbleChat(o);
break;

case "summaryPlayer":
b.default.instance.summaryPlayer(o[0]);
break;

case "vipPlayers":
var s = o[0];
s.length > 0 && b.default.instance.vipPlayer(s);
break;

case "updateRoomTime":
t.timer = o[0];
b.default.instance.updateTimer(t.timer);
break;
...
l.default.instance.onShowChat();
};
e.prototype.playerLeave = function(t) {
t[0] === b.default.instance.getAccountIdIsMe() && this.actBackGame();
};
...
var o;
e.instance = null;
s([ D(cc.Sprite) ], e.prototype, "spriteSound", void 0);
s([ D([ cc.SpriteFrame ]) ], e.prototype, "sfSounds", void 0);
s([ D(cc.Sprite) ], e.prototype, "spriteBack", void 0);
s([ D(l.default) ], e.prototype, "nodeChat", void 0);
s([ D(a.default) ], e.prototype, "MsgSystem", void 0);
s([ D(cc.Node) ], e.prototype, "NodeTooltip", void 0);
s([ D(cc.Label) ], e.prototype, "lbMsg", void 0);
s([ D(p.default) ], e.prototype, "popupSoiCau", void 0);
s([ D(c.default) ], e.prototype, "popupConfirm", void 0);
s([ D(a.default) ], e.prototype, "popupRules", void 0);
s([ D(u.default) ], e.prototype, "popupHistory", void 0);
s([ D(f.default) ], e.prototype, "popupTopRank", void 0);
s([ D(d.default) ], e.prototype, "popoupPlayersNotInGame", void 0);
s([ D(h.default) ], e.prototype, "popupMaxBet", void 0);
s([ D(a.default) ], e.prototype, "popupSetting", void 0);
return o = s([ P ], e);
}(cc.Component);
o.default = C;
cc._RF.pop();
...
var s = null;
(s = n[0] == n[1] && n[0] == n[2] ? cc.instantiate(this.nodeBaoTemp) : t.Result < 11 ? cc.instantiate(this.nodeXiuTemp) : cc.instantiate(this.nodeTaiTemp)).parent = this.nodeParent;
s.position = cc.v2(o, i);
this.drawPoints.push(cc.v2(o, i));
s.children[0].getComponent(cc.Label).string = t.Result.toString();
};
...
var o;
e.instance = null;
s([ r(cc.Node) ], e.prototype, "nodeGraphics", void 0);
s([ r(cc.Node) ], e.prototype, "nodeParent", void 0);
s([ r(cc.Node) ], e.prototype, "nodeTaiTemp", void 0);
s([ r(cc.Node) ], e.prototype, "nodeXiuTemp", void 0);
s([ r(cc.Node) ], e.prototype, "nodeBaoTemp", void 0);
s([ r(cc.Toggle) ], e.prototype, "toggleDiceSum", void 0);
s([ r(cc.Label) ], e.prototype, "lbSessionID", void 0);
s([ r(cc.Label) ], e.prototype, "lbResult", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "sfTaiXiu", void 0);
return o = s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
var c = t("../../SicboDPQ.InfoView"), a = cc._decorator, r = a.ccclass, l = a.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.nodeParent = null;
...
var t = this, e = this, o = c.default.instance.getListSoiCau()[0].ChipsData.toString().split(","), i = -1;
i = o[0] == o[1] && o[0] == o[2] ? 2 : c.default.instance.getListSoiCau()[0].Result < 11 ? 0 : 1;
var n = [], s = [];
c.default.instance.getListSoiCau().forEach(function(o) {
if (n.length <= t.maxPerCol - 1) {
var c = o.ChipsData.toString().split(","), a = -1;
if (c[0] == c[1] && c[0] == c[2]) {
a = 2;
t.countBao++;
...
var o = this.rootPosX - e * this.spaceX, i = this.rootPosY + (this.maxItemPerCol - t.length) * this.spaceY;
console.log("Col " + e + " X: " + o);
for (var n = 0; n < t.length; n++) this.createNode(t[n], cc.v2(o, i + this.spaceY * n));
};
e.prototype.createNode = function(t, e) {
...
var o;
e.instance = null;
s([ l(cc.Node) ], e.prototype, "nodeParent", void 0);
s([ l(cc.Node) ], e.prototype, "nodeTaiTemp", void 0);
s([ l(cc.Node) ], e.prototype, "nodeXiuTemp", void 0);
s([ l(cc.Node) ], e.prototype, "nodeBaoTemp", void 0);
return o = s([ r ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
var o;
e.instance = null;
s([ r(cc.Node) ], e.prototype, "nodeGraphics1", void 0);
s([ r(cc.Node) ], e.prototype, "nodeGraphics2", void 0);
s([ r(cc.Node) ], e.prototype, "nodeGraphics3", void 0);
s([ r(cc.Node) ], e.prototype, "nodeDice1Temp", void 0);
s([ r(cc.Node) ], e.prototype, "nodeDice2Temp", void 0);
s([ r(cc.Node) ], e.prototype, "nodeDice3Temp", void 0);
s([ r(cc.Toggle) ], e.prototype, "toggleDice1", void 0);
s([ r(cc.Toggle) ], e.prototype, "toggleDice2", void 0);
s([ r(cc.Toggle) ], e.prototype, "toggleDice3", void 0);
s([ r(cc.Color) ], e.prototype, "colorDice1", void 0);
s([ r(cc.Color) ], e.prototype, "colorDice2", void 0);
s([ r(cc.Color) ], e.prototype, "colorDice3", void 0);
s([ r([ cc.SpriteFrame ]) ], e.prototype, "spriteDice", void 0);
return o = s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
this.countTai = 0;
this.countXiu = 0;
c.default.instance.getListSoiCau().forEach(function(e, o) {
...
e.instance = null;
s([ l(cc.Node) ], e.prototype, "nodeParent", void 0);
s([ l([ cc.Node ]) ], e.prototype, "listNodeTemp", void 0);
s([ l(cc.Node) ], e.prototype, "nodeTaiTemp", void 0);
s([ l(cc.Node) ], e.prototype, "nodeXiuTemp", void 0);
s([ l(cc.Node) ], e.prototype, "nodeBaoTemp", void 0);
return o = s([ r ], e);
...
var c = t("../SicboDPQ.InfoView"), a = t("./graphView/SicboDPQ.GrahpDiceSumView"), r = t("./graphView/SicboDPQ.GraphCatCauView"), l = t("./graphView/SicboDPQ.GraphDice3View"), p = t("./graphView/SicboDPQ.GraphView100"), u = t("../../../framework/common/Dialog"), h = cc._decorator, d = h.ccclass, f = h.property, S = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
this.SicboDPQGraphDiceSumView.draw(c.default.instance.getListSoiCau());
this.SicboDPQGraphDice3View.draw(c.default.instance.getListSoiCau());
...
var o;
e.instance = null;
s([ f(p.default) ], e.prototype, "SicboDPQGraph100View", void 0);
s([ f(r.default) ], e.prototype, "SicboDPQGraphCatCuaView", void 0);
s([ f(a.default) ], e.prototype, "SicboDPQGraphDiceSumView", void 0);
s([ f(l.default) ], e.prototype, "SicboDPQGraphDice3View", void 0);
s([ f(cc.PageView) ], e.prototype, "pageView", void 0);
s([ f(cc.Button) ], e.prototype, "btnNext", void 0);
s([ f(cc.Button) ], e.prototype, "btnBack", void 0);
s([ f(cc.Label) ], e.prototype, "lblTotalTai", void 0);
s([ f(cc.Label) ], e.prototype, "lblTotalXiu", void 0);
s([ f(cc.Label) ], e.prototype, "lblTotalBao", void 0);
s([ f(cc.Label) ], e.prototype, "lblTotalTai1", void 0);
s([ f(cc.Label) ], e.prototype, "lblTotalXiu1", void 0);
s([ f(cc.Label) ], e.prototype, "lblTotalBao1", void 0);
return o = s([ d ], e);
}(u.default);
o.default = S;
cc._RF.pop();
...
var c = t("../../../framework/common/Dialog"), a = t("../../../framework/common/Utils"), r = t("../network/SicboDPQ.Http"), l = t("../SicboDPQ.Assets"), p = t("../SicboDPQ.Common"), u = t("../SicboDPQ.Config"), h = t("../SicboDPQ.Const"), d = t("../SicboDPQ.Controller"), f = cc._decorator, S = f.ccclass, y = f.property, b = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = [];
...
var s = t.ChipsData.split(","), c = parseInt(s[0]) + parseInt(s[1]) + parseInt(s[2]);
this.TotalDice.string = c.toString();
this.SeasionID.string = "#" + t.SessionID;
this.Time.string = "( " + t.CreateTimeFm + " )";
this.Md5.string = h.SicboDPQConst.truncateString(null !== (e = null == t ? void 0 : t.Md5String) && void 0 !== e ? e : "", 30);
this.Key.string = h.SicboDPQConst.truncateString(null !== (o = null == t ? void 0 : t.ResultString) && void 0 !== o ? o : "", 30);
...
s[0] === s[1] && s[1] === s[2] ? this.SpriteTextResult.spriteFrame = this.SpfTextResult[2] : this.SpriteTextResult.spriteFrame = c <= 10 ? this.SpfTextResult[0] : this.SpfTextResult[1];
this.SpriteDice[0].spriteFrame = l.default.instance.getSprDicesV2(parseInt(s[0]));
this.SpriteDice[1].spriteFrame = l.default.instance.getSprDicesV2(parseInt(s[1]));
this.SpriteDice[2].spriteFrame = l.default.instance.getSprDicesV2(parseInt(s[2]));
...
S.children[2].getComponent(cc.Label).string = a.default.formatNumber(u[f].Bet);
S.children[3].getComponent(cc.Label).string = a.default.formatNumber(u[f].Award);
S.active = !0;
...
f % 2 == 0 && (S.children[0].active = !0);
S.children[1].getComponent(cc.Sprite).spriteFrame = l.default.instance.getSprGateBet(y);
S.children[2].getComponent(cc.Label).string = a.default.formatNumber(d[f].Bet);
S.children[3].getComponent(cc.Label).string = a.default.formatNumber(d[f].Award);
S.active = !0;
...
s([ y(cc.Node) ], e.prototype, "content", void 0);
s([ y(cc.Node) ], e.prototype, "template", void 0);
s([ y(cc.Label) ], e.prototype, "lblPage", void 0);
s([ y(cc.Node) ], e.prototype, "btnNext", void 0);
s([ y(cc.Node) ], e.prototype, "btnBack", void 0);
s([ y(cc.Sprite) ], e.prototype, "SpriteDice", void 0);
s([ y(cc.Sprite) ], e.prototype, "SpriteTextResult", void 0);
s([ y(cc.SpriteFrame) ], e.prototype, "SpfTextResult", void 0);
s([ y(cc.Label) ], e.prototype, "SeasionID", void 0);
s([ y(cc.Label) ], e.prototype, "Time", void 0);
s([ y(cc.Label) ], e.prototype, "TotalDice", void 0);
s([ y(cc.Label) ], e.prototype, "Key", void 0);
s([ y(cc.Label) ], e.prototype, "Md5", void 0);
return s([ S ], e);
}(c.default);
o.default = b;
cc._RF.pop();
...
var n = t("../SicboDPQ.Config"), s = cc._decorator, c = s.ccclass, a = (s.property, 
function() {
function t() {}
t.sendRequest = function(t, e, o, i, s) {
var c = n.default.App.USE_WSS ? "https://" : "http://", a = cc.loader.getXMLHttpRequest();
c = c + e + "/" + o;
n.default.App.ACCESS_TOKEN && (c.includes("?") ? c += "&access_token=" + encodeURIComponent(n.default.App.ACCESS_TOKEN) : c += "?access_token=" + encodeURIComponent(n.default.App.ACCESS_TOKEN));
a.timeout = 6e4;
a.open(t, c);
...
s(e, t);
} else 200 !== a.status && s(a.status, null);
};
var r = null;
if (i) {
r = JSON.stringify(i);
...
var c = t("../../framework/common/Utils"), a = t("./SicboDPQ.Assets"), r = t("./SicboDPQ.Common"), l = t("./SicboDPQ.InputView"), p = t("./SicboDPQ.Player"), u = cc._decorator, h = u.ccclass, d = u.property, f = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lbSID = null;
...
this.lbTotalBetWin.string = "+" + c.default.formatNumber(t);
...
var e = t.Result, o = t.ChipsData.split(","), i = o[0], n = o[1], s = o[2];
...
this.listDiceHisoty[2].spriteFrame = a.default.instance.getSprDicesV2(parseInt(s));
...
var t = this, e = this.listSoiCau.slice(0, 11);
...
var o;
s([ d(cc.Label) ], e.prototype, "lbSID", void 0);
s([ d(cc.Label) ], e.prototype, "lbTimer", void 0);
s([ d(cc.ProgressBar) ], e.prototype, "progressTimer", void 0);
s([ d(cc.Label) ], e.prototype, "lbResult", void 0);
s([ d(cc.Label) ], e.prototype, "lbTotalUser", void 0);
s([ d(cc.Label) ], e.prototype, "lbTotalBetWin", void 0);
s([ d(cc.Node) ], e.prototype, "nodeChatGroupUser", void 0);
s([ d([ p.default ]) ], e.prototype, "players", void 0);
s([ d(cc.Label) ], e.prototype, "lbResultDiceHistory", void 0);
s([ d([ cc.Sprite ]) ], e.prototype, "listDiceHisoty", void 0);
s([ d(cc.Node) ], e.prototype, "nodeDiceSoiCauView", void 0);
s([ d([ cc.Sprite ]) ], e.prototype, "listNodeSoiCau", void 0);
return o = s([ h ], e);
}(cc.Component);
o.default = f;
cc._RF.pop();
...
var c = t("../../framework/common/Utils"), a = t("./network/SicboDPQ.NetWorkClient"), r = t("./settings/SicboDPQ.Settings"), l = t("./SicboDPQ.Assets"), p = t("./SicboDPQ.ChipItem"), u = t("./SicboDPQ.ChipPool"), h = t("./SicboDPQ.Common"), d = t("./SicboDPQ.Controller"), f = t("./SicboDPQ.InfoView"), S = t("./SicboDPQ.PlayerData"), y = t("./SicboDPQ.ResultView"), b = cc._decorator, g = b.ccclass, m = b.property, v = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var n = e, s = u.default.instance.createChip();
s.parent = this.nodeParentChip;
var c;
c = -1 != t ? S.default[t].position : this.posGroupUser;
s.position = c;
var a = s.getComponent(p.default);
a.betIndex = n;
a.gate = e;
a.playerId = t;
a.position = c;
...
if (-1 != t) {
var e = c.default.randomRangeInt(4, 8);
...
i.y = i.y - 60;
var n = i.x - 5, s = i.x + 5, c = i.y - 7, a = i.y + 7, r = n + Math.floor(Math.random() * Math.abs(s - n)), l = c + Math.floor(Math.random() * Math.abs(a - c));
o.moveTo(cc.v2(r, l));
};
...
var o = this.rootDealerPos.x - 20, i = this.rootDealerPos.x + 20, n = this.rootDealerPos.y + 5, s = this.rootDealerPos.y + 15, c = o + Math.floor(Math.random() * Math.abs(i - o)), a = n + Math.floor(Math.random() * Math.abs(s - n));
t.moveToEndStop(cc.v2(c, a), e);
};
...
this.currentState == h.default.GAMESTATE.BETTING ? c.default.copyToClipboard(f.default.instance.resultBetting) : c.default.copyToClipboard(f.default.instance.resultKey);
...
if (i == h.default.GATE.TAI || i == h.default.GATE.XIU) {
this.totalBets[i] += o;
this.lbTotalBets[i].string = c.default.nFormatter(this.totalBets[i]);
}
...
this.lbTotalUserBets.string = c.default.formatNumber(this.totalUserBets);
...
if (t.BetSide == h.default.GATE.TAI || t.BetSide == h.default.GATE.XIU) {
e.totalBets[t.BetSide] += t.BetValue;
e.lbTotalBets[t.BetSide].string = c.default.nFormatter(e.totalBets[t.BetSide]);
}
...
e.lbTotalUserBets.string = c.default.formatNumber(e.totalUserBets);
...
this.NodeMyBet[t[0].BetSide].getChildByName("txtMyBets").getComponent(cc.Label).string = c.default.nFormatter(t[0].SumaryBet);
lngui.EventDispatch.instance.emit(lngui.EVENT_GAMECORE.UPDATE_TOTAL_GOLD, t[1]);
}
};
var o;
e.instance = null;
s([ m(cc.Node) ], e.prototype, "nodeParentChip", void 0);
s([ m([ cc.Button ]) ], e.prototype, "btnChips", void 0);
s([ m(cc.Node) ], e.prototype, "nodeGroup", void 0);
s([ m([ cc.Node ]) ], e.prototype, "btnListChip", void 0);
s([ m(cc.ScrollView) ], e.prototype, "listChipSelect", void 0);
s([ m(cc.Button) ], e.prototype, "btnRepeat", void 0);
s([ m(cc.Button) ], e.prototype, "btnRepeatX2", void 0);
s([ m(cc.Sprite) ], e.prototype, "sprNan", void 0);
s([ m([ cc.Label ]) ], e.prototype, "lbTotalBets", void 0);
s([ m([ cc.Node ]) ], e.prototype, "NodeMyBet", void 0);
s([ m(cc.Label) ], e.prototype, "lbTotalUserBets", void 0);
return o = s([ g ], e);
}(cc.Component);
o.default = v;
cc._RF.pop();
...
s([ r(cc.ProgressBar) ], e.prototype, "progressBar", void 0);
s([ r(cc.Node) ], e.prototype, "NodeBG", void 0);
return s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
var o;
e.instance = null;
s([ r(cc.Node) ], e.prototype, "nodeDis", void 0);
return o = s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
s([ r(cc.ProgressBar) ], e.prototype, "progressBar", void 0);
s([ r(cc.Node) ], e.prototype, "movingNode", void 0);
s([ r ], e.prototype, "progressSpeed", void 0);
return s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
var s = t("../SicboDPQ.Common"), c = t("../SicboDPQ.Config"), a = t("./SicboDPQ.Http"), r = t("./SicboDPQ.Network.Clients"), l = t("./SicboDPQ.Network.Service"), p = function() {
this.M = null;
this.A = null;
this.H = null;
this.I = null;
...
var o = this;
a.default.sendRequest("GET", c.default.App.HOST_SicboDPQ.host, "/signalr/negotiate", null, function(t, i) {
if (null == t) {
o.connectToken = i.ConnectionToken;
o.tid = i.ConnectionId;
o.data = c.default.App.HOST_SicboDPQ.hub;
o.connect();
...
t.prototype.connect.call(this, c.default.App.HOST_SicboDPQ.host, null);
};
e.prototype.reConnect = function() {
this.isReconnect = !0;
t.prototype.connect.call(this, c.default.App.HOST_SicboDPQ.host, null);
...
var t = new p();
t.M = "EnterLobby";
t.A = [ s.default.Utils.getInstance().getDeviceType(), c.default.App.VIP_PLAYER ];
this.send(t);
};
...
this.lastID = this.ID;
t.H = c.default.App.HOST_SicboDPQ.hub;
t.I = this.ID;
this.ID++;
...
var i = t("../SicboDPQ.Config"), n = t("./SicboDPQ.Network.Service"), s = function() {
function t() {
this.ws = null;
this.host = null;
this.port = null;
...
var c = t("../../../framework/common/Utils"), a = t("../network/SicboDPQ.Http"), r = t("../SicboDPQ.Assets"), l = t("../SicboDPQ.Common"), p = t("../SicboDPQ.Config"), u = t("../SicboDPQ.Controller"), h = cc._decorator, d = h.ccclass, f = h.property, S = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
var n = cc.instantiate(this.template), s = n.children[0];
s.children[0].getComponent(cc.Sprite).spriteFrame = r.default.instance.getSprAvatar(o[i].Account.Avatar);
s.children[2].getComponent(cc.Label).string = l.default.Utils.getInstance().formatName(o[i].Account.NickName);
s.children[3].getComponent(cc.Label).string = c.default.formatNumber(o[i].Account.Balance);
n.active = !0;
...
var o;
e.instance = null;
s([ f(cc.Node) ], e.prototype, "content", void 0);
s([ f(cc.Node) ], e.prototype, "template", void 0);
s([ f(cc.Label) ], e.prototype, "lblPage", void 0);
s([ f(cc.Node) ], e.prototype, "btnNext", void 0);
s([ f(cc.Node) ], e.prototype, "btnBack", void 0);
s([ f(cc.Node) ], e.prototype, "nodeDis", void 0);
return o = s([ d ], e);
}(cc.Component);
o.default = S;
cc._RF.pop();
...
var c = t("../../framework/common/Utils"), a = t("./SicboDPQ.Assets"), r = t("./SicboDPQ.Common"), l = t("./SicboDPQ.InfoView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lbSID = null;
...
this.lbWin.string = "+" + c.default.formatNumber(e);
}
};
...
c.default.nFormatter(this.userInfo.Balance));
};
...
this.lbChips.string = this.userInfo.AccountID == l.default.instance.getAccountIdIsMe() ? c.default.nFormatter(this.userInfo.Balance) : c.default.nFormatter(this.userInfo.Balance < 0 ? -1 * this.userInfo.Balance : this.userInfo.Balance);
...
s([ h(cc.Label) ], e.prototype, "lbSID", void 0);
s([ h(cc.Label) ], e.prototype, "lbName", void 0);
s([ h(cc.Label) ], e.prototype, "lbNickname", void 0);
s([ h(cc.Label) ], e.prototype, "lbChips", void 0);
return s([ u ], e);
}(cc.Component);
o.default = d;
cc._RF.pop();
...
var c = t("./SicboDPQ.Common"), a = t("./SicboDPQ.Controller"), r = t("./SicboDPQ.InfoView"), l = t("./SicboDPQ.InputView"), p = t("./SicboDPQ.TouchMove"), u = t("./SicboDPQ.Const"), h = cc._decorator, d = h.ccclass, f = h.property, S = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.nodeBatNan = null;
...
var o, i, n, s, c, a, r = null === (n = null === (i = null === (o = t.allNodeGate) || void 0 === o ? void 0 : o[e.betSide]) || void 0 === i ? void 0 : i.children) || void 0 === n ? void 0 : n[4];
if (r) {
t.lstGateWin.map(Number).includes(Number(e.betSide)) ? t.currentWinBonus.push(r) : t.currentLoseBonus.push(r);
r.active = !0;
var l = null === (c = null === (s = r.children) || void 0 === s ? void 0 : s[2]) || void 0 === c ? void 0 : c.getComponent(cc.Label);
l && (l.string = "x" + e.rateMuliple);
for (var p = 0; p < 3; p++) (null === (a = r.children) || void 0 === a ? void 0 : a[p]) && (r.children[p].active = !0);
}
});
};
...
switch (t) {
case c.default.GAMESTATE.BETTING:
...
case c.default.GAMESTATE.OPEN_PLATE:
e = cc.moveTo(.5, this.getPositionDiaShaking()), o = cc.scaleTo(.5, 2.3);
this.animationBat.stopAllActions();
this.animationBat.runAction(cc.spawn(e, o));
break;

case c.default.GAMESTATE.SHAKING:
...
e.prototype.updateResult = function(t, e, o, i, n, s) {
var h = this;
switch (parseInt(i)) {
case c.default.GAMESTATE.BETTING:
...
this.dataBigWin = u.SicboDPQConst.parseStringToObj(s);
this.showGateBigWin();
...
if (h.node && h.node.active) {
if (a.default && !a.default.instance.node) return;
h.animationDiaNan.active && p.default.instance.callbackNanSuccess();
}
}, 4500);
}
...
h.animationMoBat.setAnimation(0, "open_manual_nap_end", !1);
setTimeout(function() {
if (h.node && h.node.active) {
h.playFxResult(e, o, n);
var t = e.Dice1 + "-" + e.Dice2 + "-" + e.Dice3;
parseInt(e.Dice1 + e.Dice2 + e.Dice3) < 11 ? a.default.instance.showMsg(t + " XỈU") : a.default.instance.showMsg(t + " TÀI");
...
h.animationMoBat.node.active = !1;
h.animationDia.setAnimation(0, "static_de_big", !1);
...
case c.default.GAMESTATE.SHOW_RESULT:
if (this.currentState != i) {
this.updateDice(e);
...
case c.default.GAMESTATE.WAITING:
if (this.currentState != i) {
...
this.updateDice(e);
setTimeout(function() {
a.default && !a.default.instance.node || h.playFXMoveDia(c.default.GAMESTATE.OPEN_PLATE);
}, 2e3);
}
break;
...
this.animationXocXoc.node.position = cc.v2(d, f - 80);
this.animationXocXoc.node.active = !0;
this.animationXocXoc.clearTracks();
this.animationXocXoc.setAnimation(1, "shake2", !1);
this.animationDia.setAnimation(0, "open_manual_de_idle", !1);
setTimeout(function() {
...
var e = this.resultNormal.Dice1 + "-" + this.resultNormal.Dice2 + "-" + this.resultNormal.Dice3;
parseInt(this.resultNormal.Dice1 + this.resultNormal.Dice2 + this.resultNormal.Dice3) < 11 ? a.default.instance.showMsg(e + " XỈU") : a.default.instance.showMsg(e + " TÀI");
setTimeout(function() {
...
t.animationMoBat.setAnimation(1, "open_manual_nap_end", !0);
...
var o;
s([ f(cc.Node) ], e.prototype, "nodeBatNan", void 0);
s([ f(cc.Node) ], e.prototype, "nodeDia", void 0);
s([ f(cc.Node) ], e.prototype, "animationBat", void 0);
s([ f([ cc.Sprite ]) ], e.prototype, "spriteVis", void 0);
s([ f([ cc.SpriteFrame ]) ], e.prototype, "sfVis", void 0);
s([ f(cc.Animation) ], e.prototype, "animResult", void 0);
s([ f([ cc.Node ]) ], e.prototype, "allNodeGate", void 0);
s([ f(cc.Font) ], e.prototype, "fontBonus", void 0);
return o = s([ d ], e);
}(cc.Component);
o.default = S;
cc._RF.pop();
...
s([ r(cc.Sprite) ], e.prototype, "spriteTitle", void 0);
s([ r(cc.SpriteFrame) ], e.prototype, "spfTitle", void 0);
s([ r(cc.Node) ], e.prototype, "nodeRule", void 0);
s([ r(cc.Node) ], e.prototype, "nodeBonus", void 0);
return s([ a ], e);
}(cc.Component);
o.default = l;
cc._RF.pop();
...
var c = t("../../../framework/common/Dialog"), a = cc._decorator, r = a.ccclass, l = (a.property, 
function(t) {
n(e, t);
function e() {
...
var c = t("../SicboDPQ.Controller"), a = cc._decorator, r = a.ccclass, l = a.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.sprMusic = [];
...
this.isOpenMenu = !0;
this.node.stopAllActions();
(e = cc.moveTo(.5, cc.v2(-625, 0))).easing(cc.easeQuadraticActionInOut());
var t = cc.callFunc(this.onShowFinish.bind(this), null);
this.node.runAction(cc.sequence(e, t));
} else {
this.isOpenMenu = !1;
...
c.default.instance.popupSoiCau.show();
};
e.prototype.selectBackGame = function() {
this.onSelectMenu();
c.default.instance.actBackGame();
};
e.prototype.selectRuleGame = function() {
this.onSelectMenu();
c.default.instance.popupRules.show();
};
e.prototype.selectSetting = function() {
this.onSelectMenu();
c.default.instance.popupSetting.show();
};
e.prototype.selectHistoryGame = function() {
this.onSelectMenu();
c.default.instance.popupHistory.onShow();
};
e.prototype.selectTopRankGame = function() {
this.onSelectMenu();
c.default.instance.popupTopRank.onShow();
};
e.prototype.selectMaxBet = function() {
this.onSelectMenu();
c.default.instance.popupMaxBet.onShow();
};
e.prototype.selectSessionInfo = function() {
this.onSelectMenu();
c.default.instance.popupSessionInfo.onShow();
};
e.prototype.selectPlayerNotInGame = function() {
c.default.instance.popoupPlayersNotInGame.onShow();
};
...
var o;
e.instance = null;
s([ l([ cc.SpriteFrame ]) ], e.prototype, "sprMusic", void 0);
s([ l([ cc.SpriteFrame ]) ], e.prototype, "sprSound", void 0);
s([ l(cc.Node) ], e.prototype, "nodeSound", void 0);
s([ l(cc.Node) ], e.prototype, "nodeMusic", void 0);
s([ l(cc.Node) ], e.prototype, "nodeDismiss", void 0);
s([ l(cc.AudioSource) ], e.prototype, "musicBackground", void 0);
s([ l(cc.AudioSource) ], e.prototype, "chipSelect", void 0);
s([ l(cc.AudioSource) ], e.prototype, "chipBet", void 0);
return o = s([ r ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
var c = t("../../../framework/common/Dialog"), a = t("../../../framework/common/Utils"), r = t("../network/SicboDPQ.Http"), l = t("../SicboDPQ.Config"), p = t("../SicboDPQ.Controller"), u = cc._decorator, h = u.ccclass, d = u.property, f = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
} else for (var n = i, s = 0; s < n.length; s++) {
var c = cc.instantiate(t.template), r = s + 1;
s % 2 == 0 && (c.children[0].active = !1);
if (r <= 3) {
c.children[2].active = !0;
c.children[2].getComponent(cc.Sprite).spriteFrame = t.spfRank[s];
c.children[3].color = cc.color(255, 235, 135);
}
c.children[1].getComponent(cc.Label).string = r.toString();
c.children[3].getComponent(cc.Label).string = n[s].DisplayName;
c.children[4].getComponent(cc.Label).string = "$" + a.default.formatNumber(n[s].Award);
c.active = !0;
c.parent = e.content;
}
});
};
s([ d(cc.Node) ], e.prototype, "content", void 0);
s([ d(cc.Node) ], e.prototype, "template", void 0);
s([ d(cc.SpriteFrame) ], e.prototype, "spfRank", void 0);
return s([ h ], e);
}(c.default);
o.default = f;
cc._RF.pop();
...
var c = t("./SicboDPQ.ResultView"), a = cc._decorator, r = a.ccclass, l = (a.property, 
function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
this.node.active = !1;
this.node.position = cc.v2(this.lastX, this.lastY);
c.default.instance.callbackNanSuccess();
};
var o;
return o = s([ r ], e);
}(cc.Component));
...
}, {}, [ "LabelIncrement.SicboDPQ", "SicboDPQ.Assets", "SicboDPQ.ChipItem", "SicboDPQ.ChipPool", "SicboDPQ.Common", "SicboDPQ.Config", "SicboDPQ.Const", "SicboDPQ.Controller", "SicboDPQ.InfoView", "SicboDPQ.InputView", "SicboDPQ.Loading", "SicboDPQ.MoveBullet", "SicboDPQ.Player", "SicboDPQ.PlayerData", "SicboDPQ.ResultView", "SicboDPQ.TouchMove", "SicboDPQ.Http", "SicboDPQ.NetWorkClient", "SicboDPQ.Network.Clients", "SicboDPQ.Network.Service", "SicboDPQ.GraphView", "SicboDPQ.History", "SicboDPQ.MaxBet", "SicboDPQ.PlayersNotInGame", "SicboDPQ.Rule", "SicboDPQ.SessionInfo", "SicboDPQ.TopRank", "SicboDPQ.ChatController", "SicboDPQ.ChatListView", "SicboDPQ.GrahpDiceSumView", "SicboDPQ.GraphCatCauView", "SicboDPQ.GraphDice3View", "SicboDPQ.GraphView100", "SicboDPQ.Settings" ]);