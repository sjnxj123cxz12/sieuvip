...
var t = this;
e.BetSideWins.forEach(function(e) {
t.bgWin && (t.bgWin.children[e - 1].active = !0);
});
if (1 == e.IsJackpot) {
this.nodeJackpot.active = !0;
this.dealerSkeleton.setAnimation(0, "GIRL_WinJackpot", !1);
this.scheduleOnce(function() {
t.nodeJackpot.active = !1;
}, 5);
}
};
var o;
...
a([ c(cc.Node) ], t.prototype, "nodeJackpot", void 0);
...
var o = e.Result, n = [ e.Result.Card1, e.Result.Card2, e.Result.Card3 ], i = e.Ellapsed || 0;
if (i <= 3) {
this.spriteCard[0].spriteFrame = this.altasCard.getSpriteFrame("icCard" + n[0]);
this.spriteCard[1].spriteFrame = this.altasCard.getSpriteFrame("icCard" + n[1]);
this.spriteCard[2].spriteFrame = this.altasCard.getSpriteFrame("icCard" + n[2]);
this.spriteCard.forEach(function(e) {
return e.node.active = !1;
});
if (i > 2) u.default.getInstance().chipMoveToCoin(this.currentResult, !1, 0); else try {
u.default.getInstance().removeChips(this.currentResult);
} catch (e) {}
try {
h.default.getInstance().playEffectWin(o);
} catch (e) {}
} else {
...
for (var r = 0; r < 3; r++) {
this.skeCard[r].node.active = !0;
this.skeCard[r].clearTracks();
this.skeCard[r].setToSetupPose();
this.skeCard[r].setCompleteListener(null);
}
cc.Tween.stopAllByTarget(this.node);
cc.tween(this.node).delay(.33).call(function() {
t.skeCard[0].node.active = !0;
t.skeCard[0].setAnimation(0, a[0], !1);
t.spriteCard[0].spriteFrame = t.altasCard.getSpriteFrame("icCard" + n[0]);
var e = !1;
...
t.skeCard[1].setAnimation(0, a[1], !1);
t.spriteCard[1].spriteFrame = t.altasCard.getSpriteFrame("icCard" + n[1]);
var e = !1;
...
t.skeCard[2].setAnimation(0, a[2], !1);
t.spriteCard[2].spriteFrame = t.altasCard.getSpriteFrame("icCard" + n[2]);
var e = !1;
...
if (i > 2) u.default.getInstance().chipMoveToCoin(t.currentResult, !1, 0); else try {
...
console.log("active node timer: " + e);
this.nodeTime.active = e;
};
...
a([ c(cc.Node) ], t.prototype, "nodeTime", void 0);
